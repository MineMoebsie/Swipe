...
pg.font.init()
#lucidaconsole
titelfont = pg.font.SysFont('papyrus',72)
menufont = pg.font.SysFont('papyrus',36)
menufont_klein = pg.font.SysFont('papyrus',25)
tekstfont = pg.font.SysFont('papyrus',15)
tekst_groot_font = pg.font.SysFont('papyrus',23)
settings_font = pg.font.SysFont('papyrus',20)
...
def einde_spel(scherm,schermblit): #win
    achtergrond(scherm)
    menufont = pg.font.SysFont('papyrus',100)
